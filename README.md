...
| # | Folder | Topics Covered |
|---|---|---|
| 01 | [SOC Fundamentals](./htb-cdsa/01-soc-fundamentals/) | SOC Tiers, Analyst Roles, Workflows |
| 02 | [Incident Handling](./htb-cdsa/02-incident-handling/) | IR Process, Containment, Eradication |
| 03 | [Network Analysis](./htb-cdsa/03-network-analysis/) | Traffic Analysis, IOCs, Packet Inspection |
| 04 | [Threat Hunting](./htb-cdsa/04-threat-hunting/) | Hunting Methodologies, Detection |

## 🛠️ Skills Demonstrated
- SIEM: Splunk, Chronicle
- Network Analysis: Wireshark, tcpdump
- IDS/IPS: Snort, Suricata
- Linux CLI, SQL, Python
